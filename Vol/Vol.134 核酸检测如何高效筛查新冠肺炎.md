...
以离心柱法为例，含有目标 RNA 的样本，会被加入离心柱（spi colum）中，其中加入了含有二氧化硅基质的洗涤缓冲液，并在离心机中进行离心。
...
接下来，降低温度，试剂盒中被加入的一段可以与目标 cDNA 单链排序契合的单链 DNA TaqMa 探针，会在降温后结合在 cDNA 的单链上，这个过程大概会持续 1~2 分钟。
